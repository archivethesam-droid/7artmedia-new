(function () {
  ...
  function createPopup() {
    ...
    overlay.innerHTML = [
      ...
      '        <div class="sevenart-lead-kicker">Free Growth Audit</div>',
      ...
      '        <button class="sevenart-lead-submit" type="submit"><span class="sevenart-lead-submit-text">Get my free audit</span><span class="sevenart-lead-submit-arrow" aria-hidden="true">&rarr;</span></button>',
